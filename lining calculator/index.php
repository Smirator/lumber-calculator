<div class="article-desc">
	<div class="container">
		<div class="static-content">
			<h1>Калькуляторы расчета вагонки</h1>
			<p>Наши калькуляторы помогут вам производить как простые расчеты, например, "сколько вагонки в кубе?" так и рассчитать общее количество материала для помещения с заданными размерами и
			...
			<h2>Простой расчет количества вагонки</h2>
			<p>Калькулятор для расчета параметров материала. Если выбрать расчет в кубах, калькулятор посчитает количество штук в обозначенном количестве кубов, общую 
				площадь и примерный вес вагонки. Если выбрать расчет в штуках, посчитает общий объем и примерный вес.</p>
			<div class="wrapper-calculator-block">
				<div class="calculator-block options p-15">
					<div class="wrapper-calculator-block-text flex-1-1-0 text-left">
						<ol>
							<li>Введите параметры вагонки: толщину, ширину, длину.&nbsp;

								<?php if (!empty($uniqueProps)) : ?>
								Или просто выберите из размеров, представленных в нашем <a
									href="/catalog/vagonka/">каталоге</a>, они подставятся автоматически.
					...
					<form name="calc" class="calc-form flex-1-1-0">
						<div class="wrapper-calc-timber-imitation">
							<div>
								<p class="calculator-text-value">Толщина вагонки(мм)</p>
								<input id="height" class="calculator-value important">
								<p class="calculator-text-value">Ширина вагонки(мм)</p>
								<input id="width" class="calculator-value important">
								<p class="calculator-text-value">Длина вагонки(мм)</p>
			...
			<h2>Расчет количества вагонки для поверхности</h2>
			<p>Калькулятор для рассчета нужного количества вагонки для одной поверхности (например, стены) или для помещения нестандартной формы, для случаев, когда нельзя указать точные характеристики помещения. Поддерживает исключение площадей.</p>
			<div class="wrapper-calculator-block">
				<div class="calculator-block p-15">
					...
					<div class="wrapper-result result-amount">
						<div class="calculator-block-result">
							<h3 class="calculator-text-result">Результат</h3>
							<p id="initial-msg-calc-side">Введите значения, чтобы получить общую площадь покрытия, необходимое количество вагонки, объем и примерный вес.</p>
			...
			<h2>Расчет количества вагонки для помещения</h2>
			<p>В данном калькуляторе можно рассчитать нужное количество вагонки для помещений стандартной (прямоугольной формы). Для помещений нестандартной формы воспользуйтесь калькулятором выше. Доступно исключение площадей.</p>
			<div class="wrapper-calculator-block">
				<div class="calculator-block p-15">
					...
					<div class="wrapper-result result-amount">
						<div class="calculator-block-result">
							<h3 class="calculator-text-result">Результат</h3>
							<p id="initial-msg-calc-room">Введите значения, чтобы получить общую площадь помещения, необходимое количество вагонки, объем и примерный вес.</p>
			...
			<div class="block-other">
					<p>
						Другие полезные материалы про вагонку:
					</p>
					<ul>
						<li><a href="/articles/vybor-vagonki-dlya-vnutrenney-otdelki-i-naruzhnoy-obshivki/">Выбор вагонки для внутренней отделки и наружной обшивки</a>;</li>
                        <li><a href="/articles/montazh-vagonki/">Монтаж вагонки, правила и способы крепления</a>;</li>
                        <li><a href="/articles/evrovagonka/">Евровагонка</a>;</li>
					</ul>
				</div>
		</div>
	</div>
