...
const humidity = 650; //влажность ОСП (OSB)
...
function calculateOptions() {
    ...
    // проверим, все ли нужные поля содержат значения; если нет, вернет false 
    ...
    if (checkVarValue == true) { //условие проверки, для того, чтобы не выводить значения NAN
        ...
        if (measure.value === 'cubes') {
            document.getElementById('result').innerHTML = Math.ceil(totalItems) + '  шт. ОСП (OSB) в указанном объеме (с округлением до целого числа в большую сторону)'
        } else {
            document.getElementById('result').innerHTML = countm3(totalItems).toFixed(3) + ' м³ объем данного количества ОСП (OSB)';
        }
        document.getElementById('weight-result').innerHTML = (weight(totalItems)).toFixed(2) + ' кг составляет примерный вес данного количества ОСП (OSB)';
    } else {
...
function calculateAmountSide() {
    ...
    if (checkVarValue == true) { //Проверяем и выводим значения
        ...
        if (sideArea <= 0 || amountМaterial <= 0) {
            ...
            document.getElementById('number-pieces-result-side').innerHTML = Math.ceil(payment()) + ' нужное количество шт. ОСП (OSB) (с округлением до целого числа в большую сторону)';
            document.getElementById('volume-material-side').innerHTML = amountМaterial.toFixed(2) + ' м³ необходимый объем ОСП (OSB)';
            document.getElementById('weight-result-material-side').innerHTML = weight().toFixed(2) + ' кг, примерный вес данного количества ОСП (OSB)';
...
function calculateAmount() {
    ...
    if (checkVarValue == true) { //Проверяем и выводим значения
        if (fullHomeArea <= 0 || amountМaterial <= 0) {
            ...
            document.getElementById('number-pieces-result').innerHTML = Math.ceil(payment()) + ' нужное количество шт. ОСП (OSB) (с округлением до целого числа в большую сторону)';
            document.getElementById('volume-material').innerHTML = amountМaterial.toFixed(2) + ' м³ необходимый объем ОСП (OSB)';
            document.getElementById('weight-result-material').innerHTML = weight().toFixed(2) + ' кг примерный вес данного количества ОСП (OSB)';
